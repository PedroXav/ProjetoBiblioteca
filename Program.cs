    ...
    class Program
    {
        ...
        static void PesquisaSintetica(Livros pesquisarLivro)
        {
            ...
            if (resultado != null)
            {
                ...
                Console.WriteLine("Exemplares disponíveis: " + resultado.QtdeDisponiveis());
                Console.WriteLine("Exemplares em empréstimos: " + resultado.QtdeEmprestimo());
        ...
        static void AdicionarExemplar(Livros livros)
        {
            ...
            if (livro != null)
            {
                ...
                Console.WriteLine("Insira o número do tombo: ");
